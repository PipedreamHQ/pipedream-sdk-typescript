...
export interface ConfigurablePropTimer {
    ...
    static?: ConfigurablePropTimer.Static;
    /** Default timer configuration */
    default?: ConfigurablePropTimer.Default;
    /** Available timer configuration options */
    options?: ConfigurablePropTimer.Options.Item[];
...
export namespace ConfigurablePropTimer {
    /**
     * Static timer configuration
     */
    export type Static = Pipedream.TimerInterval | Pipedream.TimerCron;
    /**
     * Default timer configuration
     */
    export type Default = Pipedream.TimerInterval | Pipedream.TimerCron;
    export type Options = Options.Item[];

    export namespace Options {
        export type Item = Pipedream.TimerInterval | Pipedream.TimerCron;
    }
}
