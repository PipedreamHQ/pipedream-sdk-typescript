...
export class ComponentsClient {
    protected readonly _options: ComponentsClient.Options;
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { projectId, after, before, limit, q, app, registry, componentType } = request;
                ...
                if (registry != null) {
                    _queryParams.registry = serializers.ListComponentsRequestRegistry.jsonOrThrow(registry, {
