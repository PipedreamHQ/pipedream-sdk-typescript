...
export class DeployedTriggersClient {
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    emitter_type:
                        emitterType != null
                            ? serializers.EmitterType.jsonOrThrow(emitterType, {
    ...
    public retrieveWebhook(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__retrieveWebhook(trigger_id, webhook_id, request, requestOptions),
        );
    }
    ...
    private async __retrieveWebhook(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.PipedreamEnvironment.Prod,
                `v1/connect/${core.url.encodePathParam(this._options.projectId)}/deployed-triggers/${core.url.encodePathParam(trigger_id)}/webhooks/${core.url.encodePathParam(webhook_id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/v1/connect/{project_id}/deployed-triggers/{trigger_id}/webhooks/{webhook_id}",
        );
    }
    ...
    public regenerateWebhookSigningKey(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__regenerateWebhookSigningKey(trigger_id, webhook_id, request, requestOptions),
        );
    }
    ...
    private async __regenerateWebhookSigningKey(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.PipedreamEnvironment.Prod,
                `v1/connect/${core.url.encodePathParam(this._options.projectId)}/deployed-triggers/${core.url.encodePathParam(trigger_id)}/webhooks/${core.url.encodePathParam(webhook_id)}/regenerate_signing_key`,
            ),
            method: "POST",
            headers: _headers,
            queryString: core.url
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/v1/connect/{project_id}/deployed-triggers/{trigger_id}/webhooks/{webhook_id}/regenerate_signing_key",
        );
    }
}
