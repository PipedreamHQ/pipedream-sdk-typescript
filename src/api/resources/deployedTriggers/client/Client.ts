...
export class DeployedTriggers {
     ...
     * @param {Pipedream.DeployedTriggersRetrieveWebhooksRequest} request
     * @param {DeployedTriggers.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Pipedream.TooManyRequestsError}
     *
     * @example
     *     await client.deployedTriggers.retrieveWebhooks("trigger_id", "webhook_id", {
     *         externalUserId: "external_user_id"
     *     })
     */
    public retrieveWebhooks(
        triggerId: string,
        webhookId: string,
        request: Pipedream.DeployedTriggersRetrieveWebhooksRequest,
        requestOptions?: DeployedTriggers.RequestOptions,
    ): core.HttpResponsePromise<Pipedream.GetWebhookWithSigningKeyResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__retrieveWebhooks(triggerId, webhookId, request, requestOptions),
        );
    }

    private async __retrieveWebhooks(
        triggerId: string,
        webhookId: string,
        request: Pipedream.DeployedTriggersRetrieveWebhooksRequest,
        requestOptions?: DeployedTriggers.RequestOptions,
