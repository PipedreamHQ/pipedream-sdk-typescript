...
export const ConfigurePropOptionItem: core.serialization.Schema<
    serializers.ConfigurePropOptionItem.Raw,
    Pipedream.ConfigurePropOptionItem
> = core.serialization.undiscriminatedUnion([PropOption, PropOptionNested]);

export declare namespace ConfigurePropOptionItem {
