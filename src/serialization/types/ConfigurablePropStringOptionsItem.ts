...
export const ConfigurablePropStringOptionsItem: core.serialization.Schema<
    serializers.ConfigurablePropStringOptionsItem.Raw,
    Pipedream.ConfigurablePropStringOptionsItem
> = core.serialization.undiscriminatedUnion([PropOption, PropOptionNested, PropOptionValue.optional()]);

export declare namespace ConfigurablePropStringOptionsItem {
