...
export const GetTriggerResponseData: core.serialization.Schema<
    serializers.GetTriggerResponseData.Raw,
    Pipedream.GetTriggerResponseData
> = core.serialization.undiscriminatedUnion([DeployedComponent, HttpInterface, TimerInterface]);

export declare namespace GetTriggerResponseData {
