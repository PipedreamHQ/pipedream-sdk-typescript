...
import { ConfigurablePropTimerStatic } from "./ConfigurablePropTimerStatic";
import { ConfigurablePropTimerDefault } from "./ConfigurablePropTimerDefault";
import { ConfigurablePropTimerOptionsItem } from "./ConfigurablePropTimerOptionsItem";
...
> = core.serialization.object({
    ...
    options: core.serialization.list(ConfigurablePropTimerOptionsItem).optional(),
...
export declare namespace ConfigurablePropTimer {
    export interface Raw {
        ...
        options?: ConfigurablePropTimerOptionsItem.Raw[] | null;
        name: string;
        label?: string | null;
