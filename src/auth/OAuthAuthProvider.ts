...
const ENV_CLIENT_ID = "PIPEDREAM_CLIENT_ID" as const;
const ENV_CLIENT_SECRET = "PIPEDREAM_CLIENT_SECRET" as const;
...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly authClient: OauthTokensClient;
    ...
    private async refresh({ endpointMetadata }: { endpointMetadata?: core.EndpointMetadata } = {}): Promise<string> {
        this.refreshPromise = (async () => {
            try {
                ...
                const tokenResponse = await this.authClient.create({
                    clientId: clientId,
