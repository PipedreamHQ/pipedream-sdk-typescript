...
describe("AccountsClient", () => {
    ...
    test("retrieve (1)", async () => {
        ...
        const response = await client.accounts.retrieve("account_id", {
            includeCredentials: true,
        });
        expect(response).toEqual({
            id: "id",
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.accounts.retrieve("account_id");
        }).rejects.toThrow(Pipedream.TooManyRequestsError);
    });
    ...
    test("delete (1)", async () => {
        ...
        const response = await client.accounts.delete("account_id");
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.accounts.delete("account_id");
        }).rejects.toThrow(Pipedream.TooManyRequestsError);
    });
    ...
    test("deleteByApp (1)", async () => {
        ...
        const response = await client.accounts.deleteByApp("app_id");
        expect(response).toEqual(undefined);
    });
