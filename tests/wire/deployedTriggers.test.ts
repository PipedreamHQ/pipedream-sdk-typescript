...
describe("DeployedTriggersClient", () => {
            ...
            data: [
                {
                    ...
                    configurable_props: [{ name: "name", type: "\\$.airtable.baseId" }],
                    configured_props: {},
                    active: true,
                    created_at: 1,
                    updated_at: 1,
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.retrieve({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.deployedTriggers.update({
            projectId: "project_id",
            triggerId: "trigger_id",
            externalUserId: "external_user_id",
        });
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.update({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("delete (1)", async () => {
        ...
        const response = await client.deployedTriggers.delete({
            projectId: "project_id",
            triggerId: "trigger_id",
            externalUserId: "external_user_id",
        });
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.delete({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("listEvents (1)", async () => {
        ...
        const response = await client.deployedTriggers.listEvents({
            projectId: "project_id",
            triggerId: "trigger_id",
            externalUserId: "external_user_id",
        });
    ...
    test("listEvents (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.listEvents({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("listWorkflows (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.listWorkflows({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("updateWorkflows (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.updateWorkflows({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
    ...
    test("listWebhooks (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.listWebhooks({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
            });
    ...
    test("updateWebhooks (1)", async () => {
        ...
        const response = await client.deployedTriggers.updateWebhooks({
            projectId: "project_id",
            triggerId: "trigger_id",
            externalUserId: "external_user_id",
            webhookUrls: ["webhook_urls"],
    ...
    test("updateWebhooks (2)", async () => {
        ...
        await expect(async () => {
            return await client.deployedTriggers.updateWebhooks({
                projectId: "project_id",
                triggerId: "trigger_id",
                externalUserId: "external_user_id",
